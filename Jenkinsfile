    ...
    stages {
        ...
        stage('Enviar Nexus') {
            steps {
                ...
                nexusArtifactUploader artifacts: '**/*', credentialsId: 'AdminNexus', groupId: 'MyWebApp', nexusUrl: 'localhost:8081/repository/Ropositorio-prueba-m3-l5/', nexusVersion: 'nexus2', protocol: 'http', repository: 'Ropositorio-prueba-m3-l5', version: '1.0.${BUILD_NUMBER}'
            }
            post {
                always {
